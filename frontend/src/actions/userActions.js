...
export const register = (name, lastName, dob, email, password,companyName,companyRegNo,companyEmail,companyAddress,type) => async (dispatch) => {
  try {
    dispatch({
    ...
    const { data } = await axios.post(
      '/api/users',
      { name, email, password,lastName, dob,companyName,companyRegNo,companyEmail,companyAddress, userType:type },
      config
    )
