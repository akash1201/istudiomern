                    ...
                    <Col md={12}>
                        ...
                        <div className="inner-sec full-size">
                            <div className="policy-detail box-shadow">
                                <h5>istudio Terms of Use</h5>


                               <div id="md_en" data-target="out_en" className="agreement_md"><h1>Terms and Conditions</h1>
                                ...
                                <ul>
                                <li>
                                <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named istudio.com</p>
                                </li>
                                <li>
                                ...
                                <li>
                                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to istudio Inc, 4545 West Sahara Ave.</p>
                                </li>
                                <li>
                                ...
                                <li>
                                <p><strong>Website</strong> refers to istudio.com, accessible from <a href="istudio.com" rel="external nofollow noopener" target="_blank">istudio.com</a></p>
                                </li>
                                <li>
                                ...
                                <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at legal@istudio.com and include in Your notice a detailed description of the alleged infringement.</p>
                                ...
                                <p>You can contact our copyright agent via email at legal@istudio.com.
                                ...
                                <ul>
                                <li>By visiting this page on our website: <a href="www.istudio.com/contactus" rel="external nofollow noopener" target="_blank">www.istudio.com/contactus</a></li>
                                </ul>
                                </div>
                            </div>
                        </div>
