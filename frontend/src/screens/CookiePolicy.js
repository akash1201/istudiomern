                        ...
                        <div className="inner-sec full-size">
                            <div className="policy-detail box-shadow">
                                ...
                                <div id="md_en" data-target="out_en" className="agreement_md">
                                        ...
                                        <ul>
                                        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to istudio Inc, 4545 West Sahara Ave.</li>
                                        <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                                        <li><strong>Website</strong> refers to istudio.com, accessible from <a href="www.istudio.com" rel="external nofollow noopener" target="_blank">www.istudio.com</a></li>
